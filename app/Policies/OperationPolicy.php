...
class OperationPolicy
{
    ...
    public function viewAny(User $user)
    {
        ...
        if(in_array('View_Operation',$user->getpermission()))
            return true;
        else
            return false;
    }
    ...
    public function create(User $user)
    {
        ...
        if(in_array('create_Operation',$user->getpermission()))
            return true;
        else
            return false;
    }
    ...
    public function update(User $user, Operation $operation)
    {
        ...
        if(in_array('Edit_Operation',$user->getpermission()))
            return true;
        else
            return false;
    }
    ...
    public function delete(User $user, Operation $operation)
    {
        ...
        if(in_array('Delete_Operation',$user->getpermission()))
            return true;
        else
            return false;
    }
    ...
    public function restore(User $user, Operation $operation)
    {
        ...
        if(in_array('Store_Operation',$user->getpermission()))
            return true;
        else
            return false;
    }
